   ...
   <?Php switch(z(33,'sil')){
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table text-nowrap">
        ...
        <thead>
            ...
            <th><input type="text" name="ara[acilis]" class="ara ufakTxt" id="araUsd" value="<?Php echo !empty($_Ara['acilis'])?$_Ara['acilis']:''?>"></th>
            <th><input type="text" name="ara[kapanis]" class="ara ufakTxt" id="araEur" value="<?Php echo !empty($_Ara['kapanis'])?$_Ara['kapanis']:''?>"></th>
            ...
            <tr>
            	...
            	<th>PAMUK TARİHİ</th><th>AÇILIŞ</th><th>KAPANIŞ</th>
