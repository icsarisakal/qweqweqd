        ...
        <form action="" method="post">
            <div class="blok">
                <table cellpadding="0" cellspacing="0"><tbody>
                	<tr><th>FİRMA AD</th><td><input type="text" name="<?Php echo $tbl?>[ad]" value="<?Php echo !empty($_X['ad'])?$_X['ad']:''?>" /><div style="margin-top:3px;"><label><input type="checkbox" name="<?Php echo $tbl?>[onayli]" value="1" <?Php echo !empty($_X['onayli'])?'checked=""checked':''?> />&nbsp;ONAYLI TEDARİKÇİ</label></div></td></tr>
