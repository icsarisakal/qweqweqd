<?php //echo '<h1><b>Bu ara modüldür detayına erişemezsiniz.</b></h1>'; exit(); ?>
<style type="text/css">
	body{
		background: white;
	}
	...
	<div class="dtysayfa printx">
		<div class="tasiyici">
			<div class="tasiyici1">
					...
					<br>
                    <a href="./?s=kumaskartifiyat&a=sticker&id=<?php echo z(8,'id'); ?>" class="formduzenleme printx" style="background:#ffd4a8;" target="_blank">STİCKER YAZDIR / STİCKER PRINT </a>
					<br>
