                    ...
                    if(gelensorgu.sonuc==1){
                        ...
                        if(pusvefaynjson!=null){
                            ...
                            $.each(pusvefaynjson, function(k, v) {
                                ...
                                var clonemuz='<label for="fname'+k+'" class="labelimiz">'+v+':</label><input type="checkbox" id="fname'+k+'" name="kumaskartifiyat[pusvefayn]['+k+'][]"><span> EN: </span><input type="text" value="0" name="kumaskartifiyat[pusvefayn]['+k+'][]" autocomplete="off"><span>cm</span><br>';
...
function fiyatyansit(ths){
    ...
    if(boyakontrolet==undefined){
        var tlfiyat='<input type="text" value="'+hesaplananfiyattl+'" class="form-control" autocomplete="off" disabled=""><input type="hidden" name="kumaskartifiyat[fiyatlar][]" value="'+hesaplananfiyattl+'">';
...
function dovizver(sorgu){
    ...
    var toplaminput3=fiyathesaplausd;
    var toplaminput='<input type="text" value="'+toplaminput+'" autocomplete="off"disabled><input type="hidden" name="kumaskartifiyat[fiyatlar][]" value="'+toplaminput+'">';
    var toplaminput2='<input type="text" value="'+toplaminput2+'" autocomplete="off"disabled>';
    var toplaminput3='<input type="text" value="'+toplaminput3+'" autocomplete="off"disabled>';
...
<tr>
    <th>Article</th>
    <td>
    <input type="text" name="<?php echo $tbl?>[article]" value="<?php echo !empty($_X['article'])?$_X['article']:''?>" autocomplete="off" class="articlemiz form-control" disabled>
    </td>
</tr>
...
<tr>
    <th>Tedarikci</th>
    <td>
    <select name="<?php echo $tbl?>[tedarikci_ID]" class="form-control" disabled>
...
<tr>
    <th>Makina Çeşidi</th>
    <td>
    <?php echo select(Array('name'=>$tbl.'[makinacesitleri_ID]','detay'=>' class="select2 select-search" id="makinacesidi" disabled','t'=>'makinacesitleri','alan'=>'ID,ad','ayrac'=>' /// ','sd'=>"",'icerik'=>'<option value="">Seçiniz</option>','sec'=>!empty($_X['makinacesitleri_ID'])?$_X['makinacesitleri_ID']:0)); ?>
    </td>
</tr>
<tr>
    <th>Kumaş Türü</th>
    ...
    ?>
    <select name="<?php echo $tbl; ?>[kumasturu_ID]" id="kumasturu" class="select2 select-search" disabled>
    <option value="0">Seçiniz</option>
...
function elyaforandegistir(ths){
    $(document).ready(function(){
        ...
        $(ths).parent().parent().parent().find("input:nth-child(1)").attr('name', 'kumaskartifiyat[elyaforanlari]['+elyf_ID+']');
    });
}
</script>
...
<?php if(!empty($bymlytler)){ ?>
   ...
   <?php 
    ...
    ?>
   <input type="text" name="kumaskartifiyat[boyamaliyet]<?php echo $bymlyt2; ?>][<?php echo $bymlyt; ?>]" value="<?php echo $bymlytler2[$bymlyt]; ?>" autocomplete="off" class="boyamaliyethesapla boyainput<?php echo $sayi; ?>" disabled="">
   <input type="hidden" name="kumaskartifiyat[boyamaliyet][<?php echo $bymlyt2; ?>][<?php echo $bymlyt; ?>]" value="<?php echo $bymlytler2[$bymlyt]; ?>" autocomplete="off" class="boyamaliyethesapla">
   <?php } } ?>
   </td>
   </tr>
    <?php } } else { ?>
