<?php echo '<h1><b>Bu ara modüldür stickera erişemezsin.</b></h1>'; exit(); ?>
<style>
.navbar{
    display:none;
}
        ...
        <div class="sticker">
			<div class="stickertop">
                ...
                <div class="stickerlogo"><img src="img/kaytekslogomuzz.png" class="img-fluid" style="width:60%;"></div>
					...
					<div class="article" style="display:none;"><span>Article</span><span>: <?php if(!empty($vt['article'])){ echo $vt['article'];} ?> </span></div>
