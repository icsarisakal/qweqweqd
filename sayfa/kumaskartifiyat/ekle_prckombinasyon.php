...
$(document).ready(function(){
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            type:"POST",
            url:"ajaxayar.php?s=fiyatcalismasi&a=ajaxkartkontrol&kumaskarti=1",
...
function kumastrhesapla(ths){
    ...
    if(tlfiyat){
        ...
        $('.kombikumastl').html('<input type="hidden" name="kumaskartifiyat[kombikumastl]" value="'+toplamfiyattl+'">');
        $('.kombitoplamtl').html('<input type="hidden" name="kumaskartifiyat[kombitoplamtl]" value="'+toplamfiyattl+'">');
    }
...
function kumasdegistir(ths){
    ...
    $.ajax({
        type:"POST",
        url:"ajaxayar.php?s=fiyatcalismasi&a=ajaxkartkontrol&fiyat="+getfiyat+"&kumas="+selectval+"&parca="+parca+"&tip=2&cakmakumas="+getid,
        success:function(gelensorgu){
            ...
            var kumasfiyatihref=origin+"/?s=kumaskartifiyat&a="+kumasduzenlemetipi+"&id=0&kumas="+selectval+"&fiyat="+getfiyat+"&parca="+parca+"&tip=2&cakmakumas="+getid;
            ...
            if(kumaskarticek!=''){
                var enselect='<select name="kumaskartifiyat[enbilgisi]['+selectval+'][]" class="kumasenselect form-control" onchange="kumashesapla(this)" ><option value="0"></option>';
                var enselectaciken='<select name="kumaskartifiyat[enbilgisiaciken]['+selectval+'][]" class="kumasenselect form-control" onchange="kumashesapla(this)" ><option value="0"></option>';
                var kumaskartienname='kumaskartifiyat[enbilgisi]['+selectval+'][]';
                ...
                */
                ...
                var fiyatselect='<input type="hidden" class="enintipi" name="bironemiyok" value="'+enTipi+'"><select class="fiyatselect form-control" name="kumaskartifiyat[fiyatselect]['+selectval+'][]" onchange="kumashesapla(this)"><option value="0">Fiyat Seçiniz</option>';
                ...
                if(kumaskarticek["fiyatlar"]!=''){
                    ...
                    $.ajax({
                        type:"POST",
                        url:"ajaxayar.php?s=fiyatcalismasi&a=ajaxkartkontrol&kumasgonder="+selectval,
                        success:function(gelensorgu){
                ...
                $.ajax({
                    type:"POST",
                    url:"ajaxayar.php?s=fiyatcalismasi&a=ajaxkartkontrol&kompozisyongonder="+selectval,
                    success:function(gelensorgu){
    ...
    $('.kombikumastl').html('<input type="hidden" name="kumaskartifiyat[kombikumastl]" value="0">');
    $('.kombitoplamtl').html('<input type="hidden" name="kumaskartifiyat[kombitoplamtl]" value="0">');
...
function kumashesapla(ths){
    ...
    */
    ...
    console.log("kumasenselect");
    console.log(kumasenselect);
    console.log("kumasgrm");
    console.log(kumasgrm);
    console.log("metredekilogram");
    console.log(metredekilogram);
...
function karorandegistir(ths){
    ...
    $(ths).parent().parent().find(".karoranlari").attr('name', 'kumaskartifiyat[karoranlari]['+kar_ID+']');
    kumastrhesapla();
}
...
<input type="hidden" class="getfiyat" value="<?php echo z(8,'fiyat'); ?>">
<input type="hidden" class="getid" value="<?php echo $_X['ID']; ?>">
...
&nbsp;<a href="#kumascogalt" class="kumasarttir btn btn-success"><b style="font-size:14px; color:white;"> <i class="icon-plus3 icon-1x"></i> </b></a>
    ...
    <th>Birim</th>
    <th colspan="2">Kumaş metre fiyatı</th>
</tr>
...
?>
        ...
        ?>
     <?php
        $kumastipiduzenle = ($kumaskartibilgisi['nesne_IDkumasTipi'] == '175')?'duzenle':'duzenletedarik';
        $kumastipiduzenleorj = ($kumaskartibilgisi['nesne_IDkumasTipi'] == '175')?'duzenle':'duzenletedarik';
        $fiyat_id = !empty(z(8,'fiyat'))?z(8,'fiyat'):'';
        $get_ID = $_X['ID'];
        $parcaid = $ien2;

        $kumasfiyatkontrol="WHERE arsiv='0' AND fiyat_ID='".$fiyat_id."' AND kumas_ID='".$ien."' AND parca_ID='".$parcaid."'";
     ...
     ?>
        ...
        <tr class="kumastr kumastr<?php echo $ensayiyeni; ?> <?php echo $class; ?>">
            <td colspan="1"><input type="checkbox" class="silinecekkumas form-control"></td>
            <td>
            <select class="getidkumas secimkumas select2 select-search" onchange="kumasdegistir(this)" id="select<?php echo $ensayiyeni; ?>" style="width:100%;" <?php echo $style; ?>>
            <option value="0">Seçiniz</option>
            <?php if(!empty($kumaslaricek)){ foreach ($kumaslaricek as $kms => $kmscek) { ?>
            ...
            <?php if($admn){ ?><a href="./?s=kumaskarti&a=<?php echo $kumastipiduzenleorj; ?>&id=<?php echo $ien; ?>" class="kumasduzenleo" target="_blank"><span class="kumasduzenle btn btn-primary"><i class="icon-clippy icon-1x"></i></span></a><?php } ?>
            <a href="./?s=kumaskartifiyat&a=<?php echo $kumastipiduzenle; ?>&id=<?php echo $kumasfiyat_id ;?><?php echo "&kumas=".$ien."&fiyat=".$fiyat_id."&parca=".$parcaid."&tip=2"."&cakmakumas=".$get_ID; ?>" class="kumasduzenlea" target="_blank"><span class="kumasduzenle btn btn-warning"><i class="icon-clippy icon-1x"></i></span></a>
            ...
            <td class="kumaseni">
                <select name="kumaskartifiyat[enbilgisi][<?php echo $ien; ?>][]" class="kumasenselect form-control" onchange="kumashesapla(this)">
            ...
            <td class="kumasacikeni">
                <select name="kumaskartifiyat[enbilgisiaciken][<?php echo $ien; ?>][]" class="kumasenselect form-control" onchange="kumashesapla(this)">
                    <option value="0"></option>
            ...
            <select class="fiyatselect form-control" name="kumaskartifiyat[fiyatselect][<?php echo $ien; ?>][]" onchange="kumashesapla(this)">
...
<tr>
    <td colspan="7" style="text-align:right;"><b>TOPLAM KUMAŞ MALİYETİ :</b></td>
...
<tr><th colspan="1">Silme</th><th colspan="13">İlave Giderler 
...
<tr>
    <td colspan="7" style="text-align:right;"><b>TOPLAM FİYAT :</b></td>
    <td colspan="1" class="usdfiyat"><b>0</b></td>
    <td colspan="1"><b>USD</b></td>
    <td colspan="1" class="eurfiyat"><b>0</b></td>
    <td colspan="1"><b>EUR</b></td>
...
<tbody>
<tr class="kayittarihi"><th>Kayit Tarihi</th><td colspan="13">
...
<tr><th colspan="14" style="text-align: right;">
<?php if(z(8,"a")=="duzenle"){ echo ' <a href="./?s='.$tbl.'&a=ekle&farkli='.$_X['ID'].'" class="btn" style="padding-top: 0px; margin-top: 4px;" target="_blank">BU VERİYİ FARKLI DÜZENLE VE KAYDET</a> '; } ?>&nbsp; 
        <?php if(z(8,"a")=="duzenle"){ ?>
            ...
            <?php } else { ?>
                <a href="?s=<?php echo z(8,'s'); ?>&a=rapor&id=<?php echo $_X['ID']; ?>&ekle=1" class="btn btn-primary" style="padding-top: 0px;margin-top: 4px;">Rapor Oluştur</a>
            <?php } ?>
        <?php } ?>
