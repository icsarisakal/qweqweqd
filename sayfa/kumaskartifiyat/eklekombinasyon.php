							...
							<table cellpadding="0" cellspacing="0" style="background: #ffffff;" class="table table-hover">
								<tbody>
									...
									<tr>
										...
										<td>
											<input type="text" name="<?php echo $tbl?>[kodu]" value="<?php echo !empty($_X['kodu'])?$_X['kodu']:''?>" autocomplete="off" class="1kumaskodu form-control" disabled>
										</td>
										<td>
											<input type="text" name="<?php echo $tbl?>[ismi]" value="<?php echo !empty($_X['ismi'])?$_X['ismi']:''?>" autocomplete="off" class="1kumasismi form-control" disabled>
										</td>
										<td>
