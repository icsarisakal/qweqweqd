...
<?php if(!empty($vt)&&$vt['arsiv']!='-1'){ ?>
	<div class="dtysayfa">
		<div class="tasiyici">
			<div class="tasiyici1">
					<?php if(!empty($vt['ad'])){  ?>
						<div class="dtyborder dtybaslik2"> Yedek Parça Adı</div>
						<div class="dtyaciklama"><?php if(!empty($vt['ad'])){ echo $vt['ad']; } ?></div>
					<?php } ?>

					<?php if(!empty($vt['parcakodu'])){  ?>
						<div class="dtyborder dtybaslik2"> Parça Kodu</div>
						<div class="dtyaciklama"><?php if(!empty($vt['parcakodu'])){ echo $vt['parcakodu']; } ?></div>
					<?php } ?>
