                ...
                <div class="form-group formrow row">
                    <div class="icblok urunblok col-12">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <select name="<?php echo $tbl; ?>[urunkategorileri][]" onchange="kategoriChange(this)" class="form-control urunkategorileri select-search select2">
                                    <option value="0">Seçiniz</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                            <select name="<?php echo $tbl; ?>[hesaplanacakebatlar][]" class="form-control urunebatlari ebatchange select-search select2" onchange="ebatChange(this)">
                                <option value="0">Seçiniz</option>
                        ...
                        <div class="card">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <?php $_Nesneaksgrup=z(37,z(1,"WHERE ad='' OR ad='aksesuargruplari' ",'ID,ad,metin1,metin2','nesne')); if(!empty($aksesuararray[$uk])){ foreach ($aksesuararray[$uk] as $aks => $aksuar) {  $aksesuarsayi=$aks+1; ?>
                                            ...
                                            <td>
                                                ...
                                                <select name="<?php echo $tbl; ?>[aksesuar][<?php echo $uk; ?>][]" onchange="aksesuarfiyatyansit(this)" class="form-control aksesuarselect select-search select2">
                                                    ...
                                                    <?php if(!empty($aksesuargruplari)){ foreach ($aksesuargruplari as $aksg => $aksgrup) { $aksesuargruplarinesnesayi=(!empty($aksgrup['nesne_IDaksesuargruplari'])?$aksgrup['nesne_IDaksesuargruplari']:0); $aksnesneadi=(!empty($_Nesneaksgrup[$aksesuargruplarinesnesayi])&&!empty($_Nesneaksgrup[$aksesuargruplarinesnesayi]['metin1'])?' - '.$_Nesneaksgrup[$aksesuargruplarinesnesayi]['metin1']:''); ?>
                                                        <option value="<?php echo $aksgrup['ID']; ?>" <?php if($aksesuararray[$uk][$aks]==$aksgrup['ID']){ echo 'selected'; } ?>><?php echo (!empty($aksgrup['renkKodu'])?$aksgrup['renkKodu'].$aksnesneadi:''); ?></option>
                                                    <?php } } ?>
                                                </select>
                        ...
                        <table class="table tablekumaslar" style="border:none;">
                            ...
                            <tbody class="kumastbody1">
                                ...
                                <tr class="kumastr kumastr1">
                                    ...
                                    <td class="kumasbirimgramaji"><input type="text" autocomplete="off" onkeyup="kumasfiyatguncelle(this)" name="<?php echo $tbl; ?>[birimgramaji][0][]" value="" class="form-control"></td>
