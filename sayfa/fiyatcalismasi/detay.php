...
$carioku='';
if(!empty($vt['cari_ID'])){
	$carioku=z(1,$vt['cari_ID'],'','cari');
}
?>
	<div class="dtysayfa">
		<div class="tasiyici">
			<div class="tasiyici1">
					<?php if(!empty($vt['teklifkodu'])){  ?>
						<div class="dtyborder dtybaslik2"> Teklif Kodu</div>
						<div class="dtyaciklama"><?php if(!empty($vt['teklifkodu'])){ echo $vt['teklifkodu']; } ?></div>
					<?php } ?>

					<?php if(!empty($carioku)){ ?>
						<div class="dtyborder dtybaslik2">Müşteri</div>
						<div class="dtyaciklama"><?php if(!empty($carioku['ad'])){ echo $carioku['ad'].' '; } if(!empty($carioku['soyad'])){ echo $carioku['soyad']; } ?></div>
					<?php } ?>
