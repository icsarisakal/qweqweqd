...
.aksesuarlaryeni .select2-container{
    width:80% !important;
    float:left;
}
.aksesuarcogalt{
...
function fiyatcogalt(ths){
    ...
    var cloneObj2 =cloneObj2.addClass(iplikyeni);
    $(ths).parent().parent().find(".bloklar").append(cloneObj2);
...
var degerset1=<?php echo (!empty($urunkategorilerisayi)?$urunkategorilerisayi:1); ?>;
function setcogalt(ths){
    var seteski="setdurum"+degerset1;
    var setdurumsayi=$(".setdurum").length;
    setdurumsayi=setdurumsayi+1;
    degerset1++;
    var setyeni="setdurum"+degerset1;
    var cloneObjset1 = $('.setdurum1').clone();
    var cloneObjset1 =cloneObjset1.removeClass(seteski);
    var cloneObjset1 =cloneObjset1.removeClass("setdurum1");
    var cloneObjset1 =cloneObjset1.addClass(setyeni);
    $(".setler").append(cloneObjset1);
    var setdurumsayisi=$(".setdurum").length;
    var blokname=(setdurumsayisi)-1;
    select2kontrol();
    toplamurunsayisi();
    aksesuarlarnameguncelle();
    arakatmanguncelle();
...
function setsilme(ths){
    var fiyatid=$('.getid').val();
    var setid=$(ths).parent().parent().index();
    $(ths).parent().parent().remove();
    toplamurunsayisi();
    //$("#formfiyatcalismasi").submit();
}
...
function navlunyuzde(ths){
    ...
    $(ths).parent().parent().find('.altkumasbirimfiyati span').each(function(ip, objfiyatspan){
        ...
        toplambilgi=fiyatbilgi+"-"+toplambirimfiyat+sondovizsimge;
...
function aksesuarlarnameguncelle() {
    var setmanuel=0;
    $('.setbeygeldisa').each(function(ip, objsetmanuel){
        var aksesuarlarsayi=0;
        $(objsetmanuel).find('.aksesuarlar').each(function(ip, objaksesuarlar){
            var tumblokyeniarray="fiyatcalismasi[aksesuar]["+setmanuel+"]["+aksesuarlarsayi+"][]";
            var tumblokyeniarray2="fiyatcalismasi[aksesuarmiktari]["+setmanuel+"]["+aksesuarlarsayi+"][]";
            var aksesuarislemname="fiyatcalismasi[aksesuarislem]["+setmanuel+"]["+aksesuarlarsayi+"][]";
...
function arakatmanguncelle() {
    ...
    $('.setbeygeldisa').each(function(ip, objsetmanuel){
        var arakatmansayi=0;
        var id=$(".getid").val();
        $(objsetmanuel).find('.tablekumaslar').each(function(ip, objarakatman){
            var pastalboyuname="fiyatcalismasi[pastalboyu]["+setmanuel+"]["+arakatmansayi+"][]";
            var pastalissayisiname="fiyatcalismasi[pastalissayisi]["+setmanuel+"]["+arakatmansayi+"][]";
            var birimgramajiname="fiyatcalismasi[birimgramaji]["+setmanuel+"]["+arakatmansayi+"][]";
            ...
            $(objarakatman).find(".kumastr").each(function(ip, objkumastr){
                ...
                var enbilgisiname="fiyatcalismasi[enbilgisi]["+setmanuel+"]["+arakatmansayi+"]["+secimkumasval+"][]";
                $(objkumastr).find(".kumasenselect").attr("name",enbilgisiname);
                var kumastipiduzenleme=$(objkumastr).find(".kumastipiduzenleme").val();
                var origin=window.location.origin;
                var kumasfiyatihref=origin+"/?s=kumaskartifiyat&a="+kumastipiduzenleme+"&id=0&kumas="+secimkumasval+"&fiyat="+id+"&blok="+arakatmansayi+"&set="+setmanuel;
...
function altislemnameguncelle() {
    ...
    $('.setbeygeldisa').each(function(ip, objsetmanuel){
        var altislemsayi=0;
        $(objsetmanuel).find('.kapsayiciblok2').each(function(ip, objaltislem){
            var aksesuarnavlunname="fiyatcalismasi[aksesuarnavlun]["+setmanuel+"]["+altislemsayi+"]";
            $(objaltislem).find(".altnavlun input").attr("name",aksesuarnavlunname);
            var aksesuarnavlundovizname="fiyatcalismasi[aksesuarnavlundoviz]["+setmanuel+"]["+altislemsayi+"]";
            $(objaltislem).find(".altnavlun select").attr("name",aksesuarnavlundovizname);
            var aksesuaramortismanname="fiyatcalismasi[aksesuaramortisman]["+setmanuel+"]["+altislemsayi+"]";
            $(objaltislem).find(".altamorisman input").attr("name",aksesuaramortismanname);
            var aksesuarfirename="fiyatcalismasi[aksesuarfire]["+setmanuel+"]["+altislemsayi+"]";
            $(objaltislem).find(".altfire input").attr("name",aksesuarfirename);
            var aksesuarkarname="fiyatcalismasi[aksesuarkar]["+setmanuel+"]["+altislemsayi+"]";
            $(objaltislem).find(".altkar input").attr("name",aksesuarkarname);
            var aksesuarkomisyonname="fiyatcalismasi[aksesuarkomisyon]["+setmanuel+"]["+altislemsayi+"]";
            $(objaltislem).find(".altkomisyon input").attr("name",aksesuarkomisyonname);
            var aksesuarfasondikimfiyatiname="fiyatcalismasi[aksesuarfasondikimfiyati]["+setmanuel+"]["+altislemsayi+"]";
            $(objaltislem).find(".altfasondikimfiyati input").attr("name",aksesuarfasondikimfiyatiname);
            var aksesuardovizname="fiyatcalismasi[aksesuardoviz]["+setmanuel+"]["+altislemsayi+"]";
            $(objaltislem).find(".aksesuardoviz select").attr("name",aksesuardovizname);
            altislemsayi++;
        }); 
        setmanuel++;
    }); 
...
function urunbilginameguncelle() {
    var setmanuel=0;
    $('.setbeygeldisa').each(function(ip, objsetmanuel){
        var urunbilgisayi=0;
        $(objsetmanuel).find('.urunblok').each(function(ip, objurunbilgi){
            var urunblokurunkategorileri="fiyatcalismasi[urunkategorileri]["+setmanuel+"][]";
            var urunblokhesaplanacakebatlar="fiyatcalismasi[hesaplanacakebatlar]["+setmanuel+"][]";
            var urunblokfasonfiyati="fiyatcalismasi[fasonfiyati]["+setmanuel+"][]";
            var urunbloksetmanuel="fiyatcalismasi[musteriebati]["+setmanuel+"][]";
            $(objurunbilgi).find(".urunkategorileri").attr("name",urunblokurunkategorileri);
            $(objurunbilgi).find(".urunebatlari").attr("name",urunblokhesaplanacakebatlar);
            $(objurunbilgi).find(".fasonfiyati").attr("name",urunblokfasonfiyati);
            $(objurunbilgi).find(".ebatgoster").attr("name",urunbloksetmanuel);
            urunbilgisayi++;
        }); 
        setmanuel++;
    }); 
...
var degeraksyeni=1;
function aksesuararttirmaortak(ths){
    var iplikeski="aksesuaryeni"+degeraksyeni;
    var selecteski="select"+degeraksyeni;
    degeraksyeni++;
    var iplikyeni="aksesuaryeni"+degeraksyeni;
    var selectyeni="select"+degeraksyeni;
    var cloneObj2 = $(ths).parent().parent().parent().parent().find('.aksesuaryeni1').clone();
    var cloneObj2 =cloneObj2.removeClass(iplikeski);
    var cloneObj2 =cloneObj2.removeClass("aksesuaryeni1");
    var cloneObj2 =cloneObj2.addClass(iplikyeni);
    $(ths).parent().parent().parent().parent().find(".aksesuarlaryeni").append(cloneObj2);
}


function ortakaksesuarsilme(ths){
    $(ths).parent().parent().parent().parent().find('.silinecekaksesuarortak').each(function(iham, objham){
        var silinecekhammaliyetsayi=$(ths).parent().parent().parent().parent().find('.silinecekaksesuarortak').length;
        if(objham.checked&&silinecekhammaliyetsayi>1){
            if(iham!='0'){
                $(objham).parent().parent().remove();
            }
...
function aksesuarkartiolustur(ths){
    $(ths).parent().find(".icblok").show();
    //$(ths).hide();
}
...
function kumasdegistir(ths){
    ...
    var setmanuel=$(ths).parent().parent().parent().parent().parent().parent().parent().parent().parent().parent().parent().parent().index();
    ...
    var origin=window.location.origin;
    var kumasfiyatihref=origin+"/?s=kumaskartifiyat&a="+kumasduzenlemetipi+"&id=0&kumas="+selectval+"&fiyat="+id+"&blok="+bulundugutbodyninindexkonumu+"&set="+setmanuel;
    ...
    if(kumaskarticek!=''){
        ...
        if(nesnekumastipi!='180'){
                ...
                $.ajax({
                    ...
                    success:function(gelensorgu){
                        console.log("gelensorguuretimveytedarik");
                        console.log(gelensorgu);
                ...
                var enselect='<select name="fiyatcalismasi[enbilgisi]['+setmanuel+']['+bulundugutbodyninindexkonumu+']['+selectval+'][]" class="kumasenselect form-control" onchange="kumashesapla(this)" style="border:1px solid #f00;" disabled><option value="0"></option>';
                var pusselect='<select name="fiyatcalismasi[pusbilgisi]['+setmanuel+']['+bulundugutbodyninindexkonumu+']['+selectval+'][]" class="kumaspusselect form-control" ><option value="0"></option>';
                var enselectaciken='<select name="fiyatcalismasi[enbilgisiaciken]['+setmanuel+']['+bulundugutbodyninindexkonumu+']['+selectval+'][]" class="kumasenselect form-control" onchange="kumashesapla(this)" ><option value="0"></option>';
                var kumaskartienname='kumaskarti[enbilgisi]['+setmanuel+']['+bulundugutbodyninindexkonumu+']['+selectval+'][]';
            ...
            $.ajax({
                ...
                success:function(gelensorgu){
                    ...
                    console.log(gelensorgu);
                    var kumastipveri=gelensorgu.cevap.kumastipveri;
                    var dipkumasgrm=gelensorgu.cevap.dipkumasgrm;
                    var dipkumaspusvefayn=gelensorgu.cevap.dipkumaspusvefayn;
                    var dipkumasnesne_IDdoviz=gelensorgu.cevap.dipkumasnesne_IDdoviz;
                    var dipkumasbirimTipi=gelensorgu.cevap.dipkumasbirimTipi;
                    var dipkumasenTipi=gelensorgu.cevap.dipkumasenTipi;
                    var randomsayi=0;
                    if(kumastipveri){
                        $.each(kumastipveri, function(k, v) {
                            var boyabaskitipiekle=kumastipveri[randomsayi];
                        ...
                        var indeximiz=$(ths).parent().parent().index();
                        var gelendoviz=dipkumasnesne_IDdoviz;
                        var gelendoviz=0;
                        var birimTipi=dipkumasbirimTipi;
                        var enTipi=dipkumasenTipi;
                        var birimyansit='kg';
                        if(birimTipi=='1'){
                            birimyansit='kg';
                        } else {
                        ...
                        if(dipkumasgrm!=''){
                            $(ths).parent().parent().find(".kumasgrm").html(dipkumasgrm);
                        }
                        if(dipkumaspusvefayn!=''){
                            var kumaspusvefayn=JSON.parse(dipkumaspusvefayn);
                            $.each(kumaspusvefayn, function(k, v) {
                                if(v[0]=="on"){
                                    if(v[1]){
                                        if(v[1]>0){
...
function kumashesapla(ths){
    ...
    $(ths).parent().parent().find(".kumasbirimgramaji input").val(birimgr2);
    ...
    $(ths).parent().parent().find('.kumasfiyat span').each(function(ip, objkumasfiyat){
        ...
        var str = kumasfiyati;
        var res = str.split("-");
        var kumasfiyati=sy(res[0]);
        if(res[1]){
            var kumasfiyati=sy(res[1]);
        }
        var kumassafbilgi='kombinasyon';
        if(res[0]){
...
function kategoriChange(ths){
    $(".ebatchange option").remove();
    var urunkategori_ID = $(ths).val();
    $.ajax({
        type:"POST",
        url:"ajaxayar.php?s=fiyatcalismasi&a=ajaxsorgu2&urunkategori_ID="+urunkategori_ID,
        success:function(gelensorgu){
            var dataEbat=gelensorgu.cevap.selectDataEbat;
            var dataFiyat=gelensorgu.cevap.dataFiyat;
            console.log(dataEbat);
            console.log(dataFiyat);
            $.each(dataEbat,
                function(index,data){
                    $(".fasonfiyati").val(dataFiyat[0]);
                    $(".ebatchange").append(new Option(dataEbat[index]['metin1'],dataEbat[index]['ID']));
                }
            );
        }
    });
...
function ebatChange(ths){
    $(".fasonfiyati").attr("disabled","true");
    var ebat_ID = $(ths).val();
    var kategori_ID = $(".urunkategorileri option:selected").val();
    $.ajax({
        type:"POST",
        url:"ajaxayar.php?s=fiyatcalismasi&a=ajaxsorgu2&kategori_ID="+kategori_ID+"&ebat_ID="+ebat_ID,
        success:function(gelensorgu){
            var fiyat=gelensorgu.cevap.fiyat;
            $(".fasonfiyati").removeAttr("disabled");
            $(".fasonfiyati").val(fiyat);
        }
    });
}
...
function aksesuarfiyatyansit(ths){
    ...
    if(aksesuarkartival){
        ...
        $(ths).parent().find(".aksesuarduzenle").show();
    }
    aksesuarfiyatitetikle();
    aksesuarcarptir(ths);
}
...
$enbilgisiyeniarray=$enbilgisiarray;
?>
<div class="setler">
    <?php if(!empty($_X['durum'])&&$_X['durum']==1){ ?>
        <h2>Set <span class="setcogalt" onclick="setcogalt(this)">ÇOĞALT</span></h2>
        <style>
        .setbeygeldisa{
    ...
    <?php $setdurumsayi=0; $setforicinarttir=0; ?>
    <?php if(!empty($enbilgisiyeniarray)){  foreach ($enbilgisiyeniarray as $endirkey => $endirvalue) { $setmanuel=$endirkey; $setdurumsayi++;   // SET BAŞLANGIÇ ?>
        <div class="setbeygeldisa setdurum setdurum<?php echo $setdurumsayi; ?>">
            <div class="bloklar">
                <h2>Fiyat Çalışması <span class="fiyatcogalt" onclick="fiyatcogalt(this)">ÇOĞALT</span></h2>
                <?php $urunsayi=0; $artansayi=0; $artmissayi=0; ?>
                <?php if(!empty($urunkategorileriarray[$setmanuel])){ foreach ($urunkategorileriarray[$setmanuel] as $uk => $uksingle) { $urunsayi++; ?>
                    <div class="tumblok tumblok<?php echo $urunsayi; ?>">
                    <div class="anablok1">
                        <div class="kapsayiciblok">
                            <h2 class="urunbaslik" onclick="urunbasliktetik(this)"><?php echo $urunsayi; ?>.Ürün <span class="kapakmusteriebati"><b>Müşteri Ebatı :</b> <span><?php echo (!empty($musteriebatiarray[$setmanuel][$uk])?$musteriebatiarray[$setmanuel][$uk]:0); ?></span></span><span class="uruntoggle" onclick="uruntoggle(this)"><i class="icon-circle-right2 mr-3 ml-3 icon-2x"></i></span><span class="altdovizbirimi"></span><span class="toplamaltfiyat"></span></h2>
                            <div class="form-group formrow row">
                                <div class="icblok urunblok col-12">
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label"> Kategori </label>
                                        <div class="col-lg-8">
                                            <select name="<?php echo $tbl; ?>[urunkategorileri][<?php echo $setmanuel; ?>][]" onchange="kategoriChange(this)" class="form-control urunkategorileri select-search select2">
                                                <option value="0">Seçiniz</option>
                                                ...
                                                <?php $urunkategorinesne_id=(!empty($ukategori['nesne_IDurunkategorileri'])?$ukategori['nesne_IDurunkategorileri']:0); $konfeksiyonkategoriad = (!empty($urunkategorileri[$urunkategorinesne_id]['metin1'])?$urunkategorileri[$urunkategorinesne_id]['metin1']:''); ?>
                                                    <option value="<?php echo $ukategori['ID']; ?>" <?php if($urunkategorileriarray[$setmanuel][$uk]==$ukategori['ID']){ echo 'selected'; } ?>><?php echo $konfeksiyonkategoriad; ?></option>
                                                <?php } } ?>
                                            </select>
                                        </div>
                                        <div class="col-lg-1">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                        <select name="<?php echo $tbl; ?>[hesaplanacakebatlar][<?php echo $setmanuel; ?>][]" class="form-control urunebatlari ebatchange select-search select2" onchange="ebatChange(this)">
                                            <option value="0">Seçiniz</option>
                                            <?php if(!empty($urunebatlari)){ foreach ($urunebatlari as $urne => $uebat) { ?>
                                                <option value="<?php echo $uebat['ID']; ?>" <?php if($hesaplanacakebatlararray[$setmanuel][$uk]==$uebat['ID']){ echo 'selected'; } ?>><?php echo (!empty($uebat['metin1'])?$uebat['metin1']:''); ?></option>
                                            <?php } } ?>
                                        </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control fasonfiyati" tabindex="1" placeholder="" name="<?php echo $tbl; ?>[fasonfiyati][<?php echo $setmanuel; ?>][]" autofocus="autofocus" value="<?php echo (!empty($fasonfiyatiarray[$setmanuel][$uk])?$fasonfiyatiarray[$setmanuel][$uk]:0); ?>" autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control ebatgoster" onkeyup="ebatyansit(this)" tabindex="1" placeholder="ÖRNEK => 150x200" name="<?php echo $tbl; ?>[musteriebati][<?php echo $setmanuel; ?>][]" autofocus="autofocus" value="<?php echo (!empty($musteriebatiarray[$setmanuel][$uk])?$musteriebatiarray[$setmanuel][$uk]:0); ?>" autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <table class="table tablekumaslar" style="border:none;">
                                        ...
                                        if(!empty($enbilgisiarray[$setmanuel][$uk])){ $kumasbirimfiyatiarray=array(); $kumasbirimmetniarray=array(); $aksesuarfiyatitoplam=0; foreach($enbilgisiarray[$setmanuel][$uk] as $ien2 => $enbilgisi2){ 
                                            $ensayi++;
                                            $ensayi2++;
                                            ...
                                            $kumaskartiorjbilgi=$kumaskartibilgisi;
                                            ...
                                            $setid=$setmanuel;
                                            $blok_id=$artmissayi;
                                            $kumasfiyatkontrol="WHERE arsiv='0' AND fiyat_ID='".$fiyat_id."' AND kumas_ID='".$kumas_id."' AND blok_ID='".$blok_id."' AND set_ID='".$setid."' ";
                                            ...
                                            $kumaskartikumastipi=(!empty($kumaskartibilgisi['nesne_IDkumasTipi'])?$kumaskartibilgisi['nesne_IDkumasTipi']:'');
                                            $kumaskartigrm=(!empty($kumaskartibilgisi['grm'])?$kumaskartibilgisi['grm']:'');
                                            ...
                                            $kumaskarticakmafiyatselect=(!empty($kumaskartibilgisi['fiyatselect'])?json_decode($kumaskartibilgisi['fiyatselect'],1):'');

                                            


                                            $kombinedengelenkumasid=0;

                                            $birimgramajinigoster=(!empty($birimgramajiarray[$artmissayi][$pastalsayi])?$birimgramajiarray[$artmissayi][$pastalsayi]:0); $birimgramajinigoster2=$birimgramajinigoster; 
                                            
                                            $fiyatlarinbilgisi=array();
                                            $fiyatlarinbilgisibirimgr=array();
                                            $sadecefiyat=array();
                                            if(!empty($kumaskarticakmafiyatselect)){
                                                foreach ($kumaskarticakmafiyatselect as $ckey => $cvalue) {

                                                    $kombinedengelenkumasid=$ckey;
                                                    $kumascekmek=z(1,$kombinedengelenkumasid,'','kumaskarti');
                                                    $kumascekfiyatlar=(!empty($kumascekmek['fiyatlar'])?json_decode($kumascekmek['fiyatlar'],1):'');
                                                    $kumascekboyamaliyet=(!empty($kumascekmek['boyamaliyet'])?json_decode($kumascekmek['boyamaliyet'],1):'');
                                                    foreach ($cvalue as $cckey => $ccvalue) {
                                                        $eksisayi=$ccvalue-1;
                                                        $degersayi=$eksisayi-$cckey;
                                                        $key=key($kumascekboyamaliyet);
                                                        next($kumascekboyamaliyet);
                                                        $key2=0;
                                                        for ($i=0; $i < $degersayi; $i++) { 
                                                            $key=key($kumascekboyamaliyet);
                                                            next($kumascekboyamaliyet);
                                                        }
                                                        $boybsk=z(1,$key,'','boyabaski');
                                                        $boybsktipi=(!empty($boybsk['tipi'])?$boybsk['tipi']:'');
                                                        $fiyatbilgi=(!empty($kumascekfiyatlar[$eksisayi])?$kumascekfiyatlar[$eksisayi]:'');
                                                        $birimgramajinigoster2=str_replace(",",".",$birimgramajinigoster2);
                                                        $fiyatbilgi2=($fiyatbilgi)*$birimgramajinigoster2;
                                                        $verimiz=$boybsktipi.'-'.$fiyatbilgi;
                                                        $verimiz2=$boybsktipi.'-'.$fiyatbilgi2;
                                                        array_push($fiyatlarinbilgisi,$verimiz);
                                                        array_push($fiyatlarinbilgisibirimgr,$verimiz2);
                                                        array_push($sadecefiyat,$fiyatbilgi2);
                                                    }
                                                }
                                            }
                                            
                                            if(!empty($kombinedengelenkumasid)&&$kumaskartikumastipi==180){
                                                $gidengetkumas=(!empty($ckey)?$ckey:0);
                                                $gidengetfiyat=(!empty($kumaskartibilgisi['fiyat_ID'])?$kumaskartibilgisi['fiyat_ID']:0);
                                                $gidenparca=0;
                                                $gidencakmakumas=(!empty($kumaskartibilgisi['ID'])?$kumaskartibilgisi['ID']:0);
                                                ...
                                                $dibdekikumasigetir=z(1,$kumasicinyenisorgu,'','kumaskartifiyat');

                                                $dibdekikumasigetir=$dibdekikumasigetir[0];
                                                //print_r($dibdekikumasigetir);

                                                $dipkumasgrm=(!empty($dibdekikumasigetir['grm'])?$dibdekikumasigetir['grm']:'');
                                                $dipkumasnesne_IDdoviz=(!empty($dibdekikumasigetir['nesne_IDdoviz'])?$dibdekikumasigetir['nesne_IDdoviz']:'');
                                                $dipkumasbirimTipi=(!empty($dibdekikumasigetir['birimTipi'])?$dibdekikumasigetir['birimTipi']:'');
                                                $dipkumasenTipi=(!empty($dibdekikumasigetir['enTipi'])?$dibdekikumasigetir['enTipi']:'');
                                                $dipkumasmkurusd=(!empty($dibdekikumasigetir['mkurusd'])?$dibdekikumasigetir['mkurusd']:'');
                                                $dipkumasmkureur=(!empty($dibdekikumasigetir['mkureur'])?$dibdekikumasigetir['mkureur']:'');
                                                $dipkumasiplikkartlari=(!empty($dibdekikumasigetir['iplikkartlari'])?$dibdekikumasigetir['iplikkartlari']:'');
                                                $dipkumaskumasfiyat=(!empty($dibdekikumasigetir['kumasfiyat'])?$dibdekikumasigetir['kumasfiyat']:'');
                                                $dipkumasboyamaliyet1=(!empty($dibdekikumasigetir['boyamaliyet'])?$dibdekikumasigetir['boyamaliyet']:'');
                                                $dipkumasboyamaliyet=(!empty($dibdekikumasigetir['boyamaliyet'])?json_decode($dibdekikumasigetir['boyamaliyet'],1):'');
                                                $dipkumasfiyatlar=(!empty($dibdekikumasigetir['fiyatlar'])?json_decode($dibdekikumasigetir['fiyatlar'],1):'');
                                                $dipkumaspusvefayn=(!empty($dibdekikumasigetir['pusvefayn'])?json_decode($dibdekikumasigetir['pusvefayn'],1):'');

                                                //$dipkumasiplikkartlari=(!empty($dibdekikumasigetir['iplikkartlari'])?json_decode($dibdekikumasigetir['iplikkartlari'],1):'');

                                                //$kumascekmek=z(1,$kombinedengelenkumasid,'','kumaskarti');
                                                $kumaskartigrm=$dipkumasgrm;
                                                $kumascekfiyatlar=$dipkumasfiyatlar;
                                                $kumascekboyamaliyet=$dipkumasboyamaliyet;
                                                $kumaskartipusvefayn=$dipkumaspusvefayn;
                                                $kumaskartibilgisi['iplikkartlari']=$dipkumasiplikkartlari;
                                                $kumaskartifiyatlar=$dipkumasfiyatlar;
                                                $kumaskartibilgisi['boyamaliyet']=$dipkumasboyamaliyet1;
                                                ...
                                                } elseif (!empty($dipkumaskumasfiyat)) {
                                                    $kumaskartifiyat=$dipkumaskumasfiyat;
                                                }
                                                $manuelkurusd=$dipkumasmkurusd;
                                                $manuelkureur=$dipkumasmkureur;
                                                $kumaskartidoviz=$dipkumasnesne_IDdoviz;
                                                ...
                                                if(!empty($dipkumasiplikkartlari)){
                                                    ...
                                                    $iplikkartlaricek=$dipkumasiplikkartlari;
                                                    $iplikkartlariarray=(!empty($dipkumasiplikkartlari)?json_decode($dipkumasiplikkartlari,1):'');
                                            ...
                                            <?php
                                                ...
                                                $fiyat_id=z(8,'id');
                                                $orjnesneidkumas=(!empty($kumaskartiorjbilgi['nesne_IDkumasTipi'])?$kumaskartiorjbilgi['nesne_IDkumasTipi']:0);
                                                $kumasfiyatkontrol="WHERE arsiv='0' AND nesne_IDkumasTipi='".$orjnesneidkumas."' AND fiyat_ID='".$fiyat_id."' AND kumas_ID='".$ien2."' AND blok_ID='".$artmissayi."'";                    
                                                $kumasfiyattablo=z(1,$kumasfiyatkontrol,'','kumaskartifiyat');
                                                ...
                                                if($orjnesneidkumas=='176'){
                                                    $kumastipiduzenle='duzenletedarik';
                                                }
                                                if($orjnesneidkumas=='180'){
                                                ...
                                                $nimet=(!empty($enbilgisiarray[$setmanuel][$ien2])?$enbilgisiarray[$setmanuel][$ien2]:0);
                                                ?>
                                            ...
                                            <tr class="kumastr kumastr<?php echo $ensayiyeni; ?> <?php echo $class; ?>">
                                                ...
                                                <td class="kumasselectli">
                                                    ...
                                                    <a href="./?s=kumaskartifiyat&a=<?php echo $kumastipiduzenle; ?>&id=<?php echo $kumasfiyat_id; ?><?php echo "&kumas=".$ien2."&fiyat=".$fiyat_id."&blok=".$artmissayi."&set=".$setmanuel; ?>" class="kumasduzenlea" target="_blank"><span class="kumasduzenle btn btn-warning"><i class="icon-clippy icon-1x"></i></span></a>
                                                ...
                                                <td class="kumasgrm"><?php if(!empty($kumasgrm)){ echo $kumasgrm; } elseif(!empty($kumaskartigrm)){ echo $kumaskartigrm; } ?></td>
                                                <td class="kumaseni">
                                                    <select name="fiyatcalismasi[enbilgisi][<?php echo $setmanuel; ?>][<?php echo $artmissayi; ?>][<?php echo $ien2; ?>][]" class="kumasenselect form-control" onchange="kumashesapla(this)">
                                                        <option value="0">Seçiniz</option>
                                                ...
                                                <td class="kumaspusu">
                                                    <select name="fiyatcalismasi[pusbilgisi][<?php echo $setmanuel; ?>][<?php echo $artmissayi; ?>][<?php echo $ien2; ?>][]" class="kumaspusselect form-control">
                                                        <option value="0">Seçiniz</option>
                                                ...
                                                <?php $birimgramajinigoster=(!empty($birimgramajiarray[$setmanuel][$artmissayi][$pastalsayi])?$birimgramajiarray[$setmanuel][$artmissayi][$pastalsayi]:0); $birimgramajinigoster2=$birimgramajinigoster; ?>
                                                
                                                <td class="kumaspastalboyukesimi"><input type="text" autocomplete="off" onkeyup="kumasfiyatguncelle(this)" name="<?php echo $tbl; ?>[pastalboyu][<?php echo $setmanuel; ?>][<?php echo $artmissayi; ?>][]" value="<?php echo (!empty($pastalboyuarray[$setmanuel][$artmissayi][$pastalsayi])?$pastalboyuarray[$setmanuel][$artmissayi][$pastalsayi]:0); ?>" class="form-control"></td>
                                                <td class="kumaspastalissayisi"><input type="text" autocomplete="off" onkeyup="kumasfiyatguncelle(this)" name="<?php echo $tbl; ?>[pastalissayisi][<?php echo $setmanuel; ?>][<?php echo $artmissayi; ?>][]" value="<?php echo (!empty($pastalissayisiarray[$setmanuel][$artmissayi][$pastalsayi])?$pastalissayisiarray[$setmanuel][$artmissayi][$pastalsayi]:0); ?>" class="form-control"></td>
                                                <td class="kumasbirimgramaji"><input type="text" autocomplete="off" onkeyup="kumasfiyatguncelle(this)" name="<?php echo $tbl; ?>[birimgramaji][<?php echo $setmanuel; ?>][<?php echo $artmissayi; ?>][]" value="<?php echo $birimgramajinigoster2; ?>" class="form-control"></td>
                                                <?php $pastalsayi++; ?>
                                                ...
                                                <input type="hidden" class="doviztipi" name="doviztipi" value="<?php echo $kumaskartidovizmetin; ?>">
                                                    <div class="fiyatselect">
                                                        ...
                                                        <?php } $ensayiyeni2++; } else {
                                                            if(!empty($fiyatlarinbilgisi)){
                                                                foreach ($fiyatlarinbilgisi as $fkey => $fvalue) { ?>
                                                                <span><?php echo $fvalue; ?></span><br>
                                                                <?php } }
                                                        } ?>
                                                    </div>
                                                ...
                                                <td class="kumasmfiyat">
                                                    ...
                                                    <?php } } else {
                                                        if(!empty($sadecefiyat)){
                                                            foreach ($sadecefiyat as $skey => $svalue) { ?>
                                                                <span><?php echo $svalue; ?></span><br>
                                                            <?php  }
                                                        }
                                                    } ?>
                                                    </div>
                                        ...
                                        <tr class="kumastr kumastr1">
                                            ...
                                            <td class="kumaspastalboyukesimi"><input type="text" autocomplete="off" onkeyup="kumasfiyatguncelle(this)" name="<?php echo $tbl; ?>[pastalboyu][0][]" class="form-control"></td>
                                            <td class="kumaspastalissayisi"><input type="text" autocomplete="off" onkeyup="kumasfiyatguncelle(this)" name="<?php echo $tbl; ?>[pastalissayisi][0][]" class="form-control"></td>
                                            <td class="kumasbirimgramaji"><input type="text" autocomplete="off" onkeyup="kumasfiyatguncelle(this)" name="<?php echo $tbl; ?>[birimgramaji][0][]" class="form-control"></td>
                                    ...
                                    <div class="card">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <?php $_Nesneaksgrup=z(37,z(1,"WHERE ad='' OR ad='aksesuargruplari' ",'ID,ad,metin1,metin2','nesne')); if(!empty($aksesuararray[$setmanuel][$uk])){ foreach ($aksesuararray[$setmanuel][$uk] as $aks => $aksuar) {  $aksesuarsayi=$aks+1; ?>
                                                    <tr class="aksesuar<?php echo $aksesuarsayi; ?>">
                                                        <td>
                                                            <span class="secilidurum btn btn-danger" onclick="seciliaksesuarsil(this)">Sil</span>
                                                            <select name="<?php echo $tbl; ?>[aksesuar][<?php echo $setmanuel; ?>][<?php echo $uk; ?>][]" onchange="aksesuarfiyatyansit(this)" class="form-control aksesuarselect select-search select2">
                                                                <option value="0">Seçiniz</option>
                                                                <?php if(!empty($aksesuargruplari)){ foreach ($aksesuargruplari as $aksg => $aksgrup) { $aksesuargruplarinesnesayi=(!empty($aksgrup['nesne_IDaksesuargruplari'])?$aksgrup['nesne_IDaksesuargruplari']:0); $aksnesneadi=(!empty($_Nesneaksgrup[$aksesuargruplarinesnesayi])&&!empty($_Nesneaksgrup[$aksesuargruplarinesnesayi]['metin1'])?' - '.$_Nesneaksgrup[$aksesuargruplarinesnesayi]['metin1']:''); ?>
                                                                    <option value="<?php echo $aksgrup['ID']; ?>" <?php if($aksesuararray[$setmanuel][$uk][$aks]==$aksgrup['ID']){ echo 'selected'; } ?>><?php echo (!empty($aksgrup['renkKodu'])?$aksgrup['renkKodu'].$aksnesneadi:''); ?></option>
                                                                <?php } } ?>
                                                            </select>
                                                        ...
                                                        <?php $seciliaksesuar=(!empty($aksesuargruplari[$aksesuararray[$setmanuel][$uk][$aks]])?$aksesuargruplari[$aksesuararray[$setmanuel][$uk][$aks]]:0); $aksesuarid=(!empty($aksesuararray[$setmanuel][$uk][$aks])?$aksesuararray[$setmanuel][$uk][$aks]:0); $aksesuarigoster=z(1,$aksesuararray[$setmanuel][$uk][$aks],'','aksesuarkarti'); $aksesuardoviz=(!empty($aksesuarigoster['nesne_IDdoviz'])?$aksesuarigoster['nesne_IDdoviz']:0); $aksesuarnesneoku=z(1,$aksesuardoviz,'','nesne'); $aksesuarbirim=(!empty($aksesuarigoster['nesne_IDbirimTipi'])?$aksesuarigoster['nesne_IDbirimTipi']:0); $aksesuarbirimnesneoku=z(1,$aksesuarbirim,'','nesne'); ?>
                                                        ...
                                                        <td><input type="text" name="<?php echo $tbl; ?>[aksesuarmiktari][<?php echo $setmanuel; ?>][<?php echo $uk; ?>][]" value="<?php $aksesuarmiktari=(!empty($aksesuarmiktariarray[$setmanuel][$uk][$aks])?$aksesuarmiktariarray[$setmanuel][$uk][$aks]:''); echo $aksesuarmiktari; ?>" class="form-control aksesuarmiktari" onkeyup="aksesuarcarptir(this)"></td>
                                                        <td class="aksesuarislem">
                                                            <select class="select2 selectislem" name="<?php echo $tbl; ?>[aksesuarislem][<?php echo $setmanuel; ?>][<?php echo $uk; ?>][]" onchange="aksesuarcarptir(this)">
                                                                <option value="0" selected>Seçiniz</option>
                                                                <option value="1" <?php if(!empty($aksesuarislemarray[$setmanuel][$uk][$aks])&&$aksesuarislemarray[$setmanuel][$uk][$aks]==1){ echo 'selected'; } ?>>Çarpma</option>
                                                                <option value="2" <?php if(!empty($aksesuarislemarray[$setmanuel][$uk][$aks])&&$aksesuarislemarray[$setmanuel][$uk][$aks]==2){ echo 'selected'; } ?>>Bölme</option>
                                                            </select>
                                                        </td>
                                                        ...
                                                        <td class="aksesuarfiyatii">
                                                            ...
                                                            if(!empty($aksesuarislemarray[$setmanuel][$uk][$aks])&&$aksesuarislemarray[$setmanuel][$uk][$aks]==1){
                                                                $aksesuarfiyati=($aksesuarbirimfiyati)*$aksesuarmiktari;
                                                                $aksesuarfiyati=($aksesuarfiyati)*$kurfiyati;
                                                            }
                                                            if(!empty($aksesuarislemarray[$setmanuel][$uk][$aks])&&$aksesuarislemarray[$setmanuel][$uk][$aks]==2){
                                                                $aksesuarfiyati=($aksesuarbirimfiyati)/$aksesuarmiktari;
                                                                $aksesuarfiyati=($aksesuarfiyati)*$kurfiyati;
                                                            }
                                                ...
                                                <?php } } else { ?>
                                                    <tr class="aksesuar1">
                                                        ...
                                                        <td><input type="text" name="<?php echo $tbl; ?>[aksesuarmiktari][<?php echo $setmanuel; ?>][0][]" value="0" class="form-control aksesuarmiktari" onkeyup="aksesuarcarptir(this)"></td>
                                                        <td class="aksesuarfiyat">0,0</td>
                                                        <td class="aksesuarislem">
                                                            <select class="select2 selectislem" name="<?php echo $tbl; ?>[aksesuarislem][<?php echo $setmanuel; ?>][0][]" onchange="aksesuarcarptir(this)">
                                                                <option value="0">Seçiniz</option>
                    ...
                    <table class="table" style="border:none;">
                        ...
                        <tbody>
                            ...
                            ?>
                            <?php if(!empty($enbilgisiarray[$setmanuel][$uk])){ ?>
                                <?php
                                $manuelkurtl='1';
                                $manuelkurusd=(!empty($_X['mkurusd'])?$_X['mkurusd']:'1');
                                $manuelkureur=(!empty($_X['mkureur'])?$_X['mkureur']:'1');
                                $aksesuarnavlunfiyat=(!empty($aksesuarnavlunarray[$setmanuel][$uk])?$aksesuarnavlunarray[$setmanuel][$uk]:0);   
                                $aksesuarnavlundoviz=(!empty($aksesuarnavlundovizarray[$setmanuel][$uk])?$aksesuarnavlundovizarray[$setmanuel][$uk]:0);   
                                $aksesuardoviz=(!empty($aksesuardovizarray[$setmanuel][$uk])?$aksesuardovizarray[$setmanuel][$uk]:0);   
                                $aksesuarkomisyon=(!empty($aksesuarkomisyonarray[$setmanuel][$uk])?$aksesuarkomisyonarray[$setmanuel][$uk]:0);   
                                $aksesuaramortisman=(!empty($aksesuaramortismanarray[$setmanuel][$uk])?$aksesuaramortismanarray[$setmanuel][$uk]:0);   
                                $aksesuarfire=(!empty($aksesuarfirearray[$setmanuel][$uk])?$aksesuarfirearray[$setmanuel][$uk]:0);   
                                $aksesuarkar=(!empty($aksesuarkararray[$setmanuel][$uk])?$aksesuarkararray[$setmanuel][$uk]:0);
                                $aksesuarfasondikimfiyati=(!empty($aksesuarfasondikimfiyatiarray[$setmanuel][$uk])?$aksesuarfasondikimfiyatiarray[$setmanuel][$uk]:0);
                                $kurfiyati='1';
                                ...
                                ?>
                            <tr class="sonislemtr">
                                <td class="altmusteriebati"><?php echo (!empty($musteriebatiarray[$setmanuel][$uk])?$musteriebatiarray[$setmanuel][$uk]:0); ?></td>
                                <td class="altkumasbirimfiyati">
                                    ...
                                    <?php } } else { 
                                        if(!empty($fiyatlarinbilgisibirimgr)){
                                            foreach ($fiyatlarinbilgisibirimgr as $fiyatkey => $fiyatvalue) { ?>
                                            <span><?php echo $fiyatvalue.'₺'; ?></span>
                                            <?php }
                                        }
                                    } ?>
                                </td>
                                <td class="altaksesuarfiyati"><?php echo $aksesuarfiyatitoplam.'₺'; ?></td>
                                <td class="altfasondikimfiyati"><input type="text" name="<?php echo $tbl; ?>[aksesuarfasondikimfiyati][<?php echo $setmanuel; ?>][<?php echo $uk; ?>]" autocomplete="off" value="<?php echo $aksesuarfasondikimfiyati; ?>" onkeyup="navlunyuzde(this)" class="form-control"></td>
                                <td class="altnavlun"><input type="text" class="form-control" autocomplete="off" name="<?php echo $tbl; ?>[aksesuarnavlun][<?php echo $setmanuel; ?>][<?php echo $uk; ?>]" onkeyup="navlunfiyat(this)" value="<?php echo $aksesuarnavlunfiyat; ?>">
                                    <select class="select2 form-control altdovizselect" name="<?php echo $tbl; ?>[aksesuarnavlundoviz][<?php echo $setmanuel; ?>][<?php echo $uk; ?>]" onchange="navlunfiyatdoviz(this)">
                                        <option value="0">Seçiniz</option>
                                ...
                                <td class="altamorisman"><input type="text" class="form-control" autocomplete="off" onkeyup="navlunyuzde(this)" name="<?php echo $tbl; ?>[aksesuaramortisman][<?php echo $setmanuel; ?>][<?php echo $uk; ?>]" value="<?php echo $aksesuaramortisman; ?>"></td>
                                <td class="altfire"><input type="text" class="form-control" autocomplete="off" onkeyup="navlunyuzde(this)" name="<?php echo $tbl; ?>[aksesuarfire][<?php echo $setmanuel; ?>][<?php echo $uk; ?>]" value="<?php echo $aksesuarfire; ?>"></td>
                                <td class="altkar"><input type="text" class="form-control" autocomplete="off" onkeyup="navlunyuzde(this)" name="<?php echo $tbl; ?>[aksesuarkar][<?php echo $setmanuel; ?>][<?php echo $uk; ?>]" value="<?php echo $aksesuarkar; ?>"></td>
                                <td class="altkomisyon"><input type="text" class="form-control" autocomplete="off" onkeyup="navlunyuzde(this)" name="<?php echo $tbl; ?>[aksesuarkomisyon][<?php echo $setmanuel; ?>][<?php echo $uk; ?>]" value="<?php echo $aksesuarkomisyon; ?>"></td>
                                <td class="aksesuardoviz">
                                    <select class="select2 form-control aksesuardovizselect" name="<?php echo $tbl; ?>[aksesuardoviz][<?php echo $setmanuel; ?>][<?php echo $uk; ?>]" onchange="navlunyuzde(this)">
                                        <option value="0">Seçiniz</option>
                                ...
                                <?php if(!empty($kumasbirimmetniarray)){ foreach ($kumasbirimmetniarray as $kbrfiyat => $kmsbrmfiyat) { ?>
                                        <span>
                                            <?php
                                                $kumasbirimfiyati=($kmsbrmfiyat+$aksesuarfiyatitoplam+$aksesuardovizlifiyat+$aksesuarfasondikimfiyati);
                                                ...
                                                echo $kbrfiyat.$kumasbirimfiyati.$aksesuardovizsimge; 
                                            ?></span>
                                    <?php } } else {
                                        if(!empty($fiyatlarinbilgisibirimgr)){ foreach ($fiyatlarinbilgisibirimgr as $grbilgifiyat => $bilgigrvalue) { ?>
                                            <span>
                                                <?php
                                                    $fiyatiparcala=explode("-",$bilgigrvalue);
                                                    $fiyattanim=$fiyatiparcala[0];
                                                    $fiyattutar=$fiyatiparcala[1];
                                                    $kumasbirimfiyati=($fiyattutar+$aksesuarfiyatitoplam+$aksesuardovizlifiyat+$aksesuarfasondikimfiyati);
                                                    $aksesuarkomisyonyuzde=(100+$aksesuarkomisyon)/100;
                                                    $aksesuaramortismanyuzde=(100+$aksesuaramortisman)/100;
                                                    $aksesuarfireyuzde=(100+$aksesuarfire)/100;
                                                    $aksesuarkaryuzde=(100+$aksesuarkar)/100;
                                                    ...
                                                    $kumasbirimfiyati=($kumasbirimfiyati)/$kurfiyatidoviz;
                                                    $kumasbirimfiyati=number_format($kumasbirimfiyati,2, '.', '');
                                                    echo $fiyattanim.'-'.$kumasbirimfiyati.$aksesuardovizsimge; 
                                                ?></span>
                                        <?php } } 
                                    } ?>
                                </td>
                            ...
                            <div class="form-group formrow row">
                                <div class="icblok urunblok col-12">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Fason Fiyatı</label>
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control fasonfiyati" tabindex="1" placeholder="" name="<?php echo $tbl; ?>[fasonfiyati][<?php echo $setmanuel; ?>][]" autofocus="autofocus" value="" autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Müşteri Ebatı</label>
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control ebatgoster" onkeyup="ebatyansit(this)" tabindex="1" placeholder="ÖRNEK => 150x200" name="<?php echo $tbl; ?>[musteriebati][<?php echo $setmanuel; ?>][]" autofocus="autofocus" value="" autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <table class="table tablekumaslar" style="border:none;">
                                        ...
                                        <tbody class="kumastbody1">
                                            ...
                                            <tr class="kumastr kumastr1">
                                                ...
                                                <td class="kumaskompozisyonu">-</td>
                                                <td class="kumasgrm">-</td>
                                                <td class="kumaseni"><select name="" class="kumasenselect form-control" onchange="kumashesapla(this)"></select></td>
                                                <td class="kumaspusu"> -</td>
                                                <td class="kumaspastalboyukesimi"><input type="text" autocomplete="off" onkeyup="kumasfiyatguncelle(this)" name="<?php echo $tbl; ?>[pastalboyu][<?php echo $setmanuel; ?>][0][]" value="" class="form-control"></td>
                                                <td class="kumaspastalissayisi"><input type="text" autocomplete="off" onkeyup="kumasfiyatguncelle(this)" name="<?php echo $tbl; ?>[pastalissayisi][<?php echo $setmanuel; ?>][0][]" value="" class="form-control"></td>
                                                <td class="kumasbirimgramaji"><input type="text" autocomplete="off" onkeyup="kumasfiyatguncelle(this)" name="<?php echo $tbl; ?>[birimgramaji][<?php echo $setmanuel; ?>][0][]" value="" class="form-control"></td>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tr class="aksesuar1">
                                                        <td>
                                                            <span class="secilidurum btn btn-danger" onclick="seciliaksesuarsil(this)">Sil</span>
                                                            <select name="<?php echo $tbl; ?>[aksesuar][<?php echo $setmanuel; ?>][0][]" onchange="aksesuarfiyatyansit(this)" class="form-control aksesuarselect select-search select2">
                                                                <option value="0">Seçiniz</option>
                                                                <?php if(!empty($aksesuargruplari)){ foreach ($aksesuargruplari as $aksg => $aksgrup) { ?>
                                                                    <option value="<?php echo $aksgrup['ID']; ?>"><?php echo (!empty($aksgrup['renkKodu'])?$aksgrup['renkKodu']:''); ?></option>
                                                                <?php } } ?>
                                                        ...
                                                        <td><input type="text" name="<?php echo $tbl; ?>[aksesuarmiktari][<?php echo $setmanuel; ?>][0][]" value="" class="form-control aksesuarmiktari" onkeyup="aksesuarcarptir(this)"></td>
                                                        <td class="aksesuarislem">
                                                            <select class="select2 selectislem" name="<?php echo $tbl; ?>[aksesuarislem][<?php echo $setmanuel; ?>][0][]" onchange="aksesuarcarptir(this)">
                                                                <option value="0">Seçiniz</option>
                                                                <option value="1">Çarpma</option>
                        ...
                        <table class="table" style="border:none;">
                            ...
                            <tbody>
                                <tr class="sonislemtr">
                                    ...
                                    <td class="altfasondikimfiyati"><input type="text" name="<?php echo $tbl; ?>[aksesuarfasondikimfiyati][<?php echo $setmanuel; ?>][0]" autocomplete="off" onkeyup="navlunyuzde(this)" class="form-control"></td>
                                    <td class="altnavlun">
                                        <input type="text" class="form-control" autocomplete="off" name="<?php echo $tbl; ?>[aksesuarnavlun][<?php echo $setmanuel; ?>][0]" onkeyup="navlunfiyat(this)" value="0">
                                        <select class="select2 form-control altdovizselect" name="<?php echo $tbl; ?>[aksesuarnavlundoviz][<?php echo $setmanuel; ?>][0]" onchange="navlunfiyatdoviz(this)">
                                            <option value="0">Seçiniz</option>
                                    ...
                                    <td class="altamorisman"><input type="text" class="form-control" autocomplete="off" onkeyup="navlunyuzde(this)" name="<?php echo $tbl; ?>[aksesuaramortisman][<?php echo $setmanuel; ?>][0]" value="0"></td>
                                    <td class="altfire"><input type="text" class="form-control" autocomplete="off" onkeyup="navlunyuzde(this)" name="<?php echo $tbl; ?>[aksesuarfire][<?php echo $setmanuel; ?>][0]" value="0"></td>
                                    <td class="altkar"><input type="text" class="form-control" autocomplete="off" onkeyup="navlunyuzde(this)" name="<?php echo $tbl; ?>[aksesuarkar][<?php echo $setmanuel; ?>][0]" value="0"></td>
                                    <td class="altkomisyon"><input type="text" class="form-control" autocomplete="off" onkeyup="navlunyuzde(this)" name="<?php echo $tbl; ?>[aksesuarkomisyon][<?php echo $setmanuel; ?>][0]" value="0"></td>
                                    <td class="aksesuardoviz">
                                        <select class="select2 form-control aksesuardovizselect" name="<?php echo $tbl; ?>[aksesuardoviz][<?php echo $setmanuel; ?>][0]" onchange="navlunyuzde(this)">
                                            <option value="0">Seçiniz</option>
                                            <option value="74">₺</option>
                                            <option value="75">$</option>
                                            <option value="76">€</option>
            ...
            <?php if(!empty($_X['durum'])&&$_X['durum']==1){ ?>
            <?php for ($setsilfor=0; $setsilfor <1; $setsilfor++) { ?>
                <div class="setsilmealani"><a href="#sil" onclick="setsilme(this)" style="font-weight:bold; padding: 3px; margin-top: 4px;">Sil</a></div>
            <?php } ?>
    <?php } ?>
        </div>
    <?php $setmanuel=0; $setforicinarttir++; } }  ?>
    <?php $setforicinarttir=0; ?>
    <?php if(empty($enbilgisiyeniarray)){ for ($setfor=0; $setfor <1 ; $setfor++) { $setdurumsayi++;   ?>
        <div class="setbeygeldisa setdurum setdurum<?php echo $setdurumsayi; ?>">
            <div class="bloklar">
                <h2>Fiyat Çalışması <span class="fiyatcogalt" onclick="fiyatcogalt(this)">ÇOĞALT</span></h2>
                <?php $urunsayi=0; $artansayi=0; $artmissayi=0; ?>
                                    ...
                                    <table class="table tablekumaslar" style="border:none;">
                                        ...
                                        if(!empty($enbilgisiarray[$setmanuel][$uk])){ $kumasbirimfiyatiarray=array(); $kumasbirimmetniarray=array(); $aksesuarfiyatitoplam=0; foreach($enbilgisiarray[$setmanuel][$uk] as $ien2 => $enbilgisi2){ 
                                            ...
                                            <tr class="kumastr kumastr<?php echo $ensayiyeni; ?> <?php echo $class; ?>">
                                                ...
                                                <td class="kumasselectli">
                                                    <span class="secilidurum btn btn-danger" onclick="secilikumasisil(this)">Sil</span>
                                                    <a href="./?s=kumaskartifiyat&a=<?php echo $kumastipiduzenle; ?>&id=<?php echo $kumasfiyat_id; ?><?php echo "&kumas=".$ien2."&fiyat=".$fiyat_id."&blok=".$artmissayi."&set=".$setforicinarttir; ?>" class="kumasduzenlea" target="_blank"><span class="kumasduzenle btn btn-warning"><i class="icon-clippy icon-1x"></i></span></a>
                                                    <?php if($admn){ ?><a href="./?s=kumaskarti&a=<?php echo $kumastipiduzenleorj; ?>&id=<?php echo $kumasorjid; ?>" class="kumasduzenleo" target="_blank"><span class="kumasduzenle btn btn-primary"><i class="icon-clippy icon-1x"></i></span></a><?php } ?>
                                                <select  class="secimkumas select2 select-search" onchange="kumasdegistir(this)" id="select<?php echo $ensayiyeni; ?>" style="width:100%;" <?php echo $style; ?>>
                                                <option value="0">Seçiniz</option>
                                                <?php if(!empty($kumaskarticek)){ foreach ($kumaskarticek as $kms => $kmscek) { ?>
