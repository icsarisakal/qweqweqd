...
$_Th=array(
    ...
    array(
        ...
        'iliskiliSutunAdlari'=>'',
        'sorguDetay'=>'',
        'thIcerigi'=>'<th>Kumaş Türü Adı</th>',
        'genislik'=>'',
        'filtreGrup'=>'ad'
    ),
    // Makina Çeşitleri (tablo)
    array(
        'tip'=>'tablo',
        'sutunAdi'=>'makinacesitleri', // Sütun adı tablo adına dönüştü
        'deger'=>'',
        'iliskiliSutunAdlari'=>'',
        'sorguDetay'=>'',
    ...
    array(
        ...
        'iliskiliSutunAdlari'=>'',
        'sorguDetay'=>'',
        'thIcerigi'=>'<th>Makina Özellikleri</th>',
        'genislik'=>'',
        'filtreGrup'=>''
    ),
    ...
    array(
        'tip'=>'text',
        'sutunAdi'=>'fasonmaliyet',
        'deger'=>'',
        'iliskiliSutunAdlari'=>'',
        'sorguDetay'=>'',
        'thIcerigi'=>'<th>Fason Örgü Maliyeti</th>',
        'genislik'=>'',
        'filtreGrup'=>'fasonmaliyet'
    ),
    array(
        'tip'=>'nesne',
...
$_NSN=array(
    'doviz'=>array(
        'ad'=>'Doviz Cinsi',
        'alan'=>'metin1',
        'alan2'=>array('metin1'=>'Doviz Cinsi')
    ),    

);
$_NSN2=array(
    'makineYetenegi'=>array(
        'ad'=>'Makine İşlevleri',
        'alan'=>'metin1',
        'alan2'=>array('metin1'=>'Makine İşlevleri')
    ),    
);
