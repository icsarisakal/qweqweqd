...
require(__DIR__.'/konfeksiyonmaliyetleri/ayar.php');
if(z(8,'a')){
	$a=z(8,'a');
	...
	if(z('lgn','admin')||ytk(z(8,'s'), str_replace(array('listele','detay','ekle','duzenle'),array('listele','detay','ekle','duzenle'),$a) )){
