...
$vt=z(1,$id,'','rapor');
    ...
    if(z(7,$tbl2)){
        ...
        $igneiplikuzunlugu=(!empty($_X['igneiplikuzunlugu'])?$_X['igneiplikuzunlugu']:'');
        if(!empty($igneiplikuzunlugu)){$igneiplikuzunlugu=!empty($igneiplikuzunlugu)?json_encode($igneiplikuzunlugu):Null;}
        $_X['igneiplikuzunlugu']=(!empty($igneiplikuzunlugu)?$igneiplikuzunlugu:'');
        
        $igneiplikuzunlugu2=(!empty($_X['igneiplikuzunlugu2'])?$_X['igneiplikuzunlugu2']:'');
        if(!empty($igneiplikuzunlugu2)){$igneiplikuzunlugu2=!empty($igneiplikuzunlugu2)?json_encode($igneiplikuzunlugu2):Null;}
        $_X['igneiplikuzunlugu2']=(!empty($igneiplikuzunlugu2)?$igneiplikuzunlugu2:'');
...
$igneiplikuzunluguarray=array();
$igneiplikuzunlugu2array=array();
if(!empty($vt)){
...
$igneiplikuzunlugucek=$vt['igneiplikuzunlugu'];
$igneiplikuzunluguarray=(!empty($vt['igneiplikuzunlugu'])?json_decode($vt['igneiplikuzunlugu'],1):'');
$igneiplikuzunlugu2array=(!empty($vt['igneiplikuzunlugu2'])?json_decode($vt['igneiplikuzunlugu2'],1):'');
}
$eskiveri='';
...
function raporyansit(ths){
    ...
    if(raporuoku["eknot"]!=null){
        var eknot=JSON.parse(raporuoku["eknot"]);
            if(eknot!=null){
                $.each(eknot, function(k, v) {
                eknotbilgi=eknotbilgi+'<br><td class="eknot" id="eknot"><input type="text" name="rapor[eknot]['+k+']" class="eknotumuz form-control" autocomplete="off" placeholder="Ek not" style="display:block;" value="'+v+'"></td>';
            }); 
        }
        eknotbilgi=eknotbilgi+'</tr>';
    } else {
        ...
        var sistemfor;
        for (sistemfor = 0; sistemfor < sistemsayivt; sistemfor++) {
            eknotbilgi=eknotbilgi+'<br><td class="eknot" id="eknot"><input type="text" name="rapor[eknot]['+dongusayi+']" class="eknotumuz form-control" autocomplete="off" placeholder="Ek not" style="display:block;" value=""></td>';
            dongusayi++;
        }
        eknotbilgi=eknotbilgi+'</tr>';
    }
    ...
    if(raporuoku["iplikdizilim"]!=null){
        ...
        var igneiplikuzunlugu=JSON.parse(raporuoku["igneiplikuzunlugu"]);
        if(iplikdizilim!=null){
            $.each(iplikdizilim, function(k, v) {
                iplikdizilimsayi++;
                var iplikselectust='<td class="selectiplik" id="selectiplik">'+selectarttir;
                iplikselect='';
                var silsayikontrol=0;
                console.log(igneiplikuzunlugu);
                var igneiplikhtml='<span><input type="text" name="rapor[igneiplikuzunlugu]['+k+']" class="form-control" value=""></span>';
                if(igneiplikuzunlugu){
                    var igneiplikdizimtekveri=igneiplikuzunlugu[k];
                    igneiplikhtml='<span><input type="text" name="rapor[igneiplikuzunlugu]['+k+']" class="form-control" value="'+igneiplikdizimtekveri+'"></span>';
                }
                $.each(iplikdizilim[k], function(c, x) {
                    var selectclass="selectisil";
                    if(silsayikontrol!=0){
                ...
                iplikselectyeni=iplikselectyeni+iplikselectust+iplikselect+igneiplikhtml+'</td>';
            }); 
            ipliktr='<tr class="iplikdizilimi"><th>İplik Dizilimi<br>&&<br> <span style="position: relative;top: 8px;"> 100 iğne ipl. uz.</span></th>'+iplikselectyeni+'</tr>';
        }
    } else {
        var dongusayi=0;
        var iplikselectust='<td class="selectiplik" id="selectiplik">'+selectarttir;
                        ...
                        <?php if(!empty($pusvefayn['plaka'])&&$pusvefayn['plaka']=='2'){ echo '<input type="hidden" name="'.$tbl2.'[plaka]" value="2">'; } else{ echo '<input type="hidden" name="'.$tbl2.'[plaka]" value="1">'; } ?> 
                            ...
                            <tbody class="tbody">
                                ...
                                <tr>
                                    ...
                                    <th>İplik Dizilimi<br>&&<br> <span style="position: relative;top: 18px;"> 100 iğne ipl. uz.</span></th>
                                    <?php if(!empty($iplikdizilimarray)){ foreach ($iplikdizilimarray as $ipdz => $iplikdiz) { ?>
                                        ...
                                        <?php } ?>
                                        <span><input type="text" name="rapor[igneiplikuzunlugu][<?php echo $ipdz; ?>]" class="form-control" value="<?php echo (!empty($igneiplikuzunluguarray[$ipdz])?$igneiplikuzunluguarray[$ipdz]:''); ?>"></span>
                                        <?php } else { ?>
                                            <div>
                                                <select name="rapor[iplikdizilim][<?php echo $ipdz; ?>][]" class="form-control">
                                                    <option value="0">Seçiniz</option>
