	...
	<div class="dtysayfa">
		<div class="tasiyici">
			<div class="tasiyici1">
					...
					<?php if($vt['cari_ID']!=0){  ?>
						<div class="dtyborder dtybaslik2"> Boyahane</div>
						<div class="dtyaciklama"><?php if(!empty($boyaHane[$vt['cari_ID']]['ad'])){ echo $boyaHane[$vt['cari_ID']]['ad']; } ?></div>
					<?php } ?>


					<?php if($_Nesne[$vt['nesne_IDaksesuargruplari']]['ad']=='aksesuargruplari'){  ?>
						<div class="dtyborder dtybaslik2"> Döviz</div>
						<div class="dtyaciklama"><?php if(!empty($_Nesne[$vt['nesne_IDaksesuargruplari']]['metin1'])){ echo $_Nesne[$vt['nesne_IDaksesuargruplari']]['metin1']; } ?></div>
					<?php } ?>
					...
					<?php if($_Nesne[$vt['nesne_IDbirimTipi']]['ad']=='birimTipi'){  ?>
						<div class="dtyborder dtybaslik2"> Döviz</div>
						<div class="dtyaciklama"><?php if(!empty($_Nesne[$vt['nesne_IDbirimTipi']]['metin1'])){ echo $_Nesne[$vt['nesne_IDbirimTipi']]['metin1']; } ?></div>
					<?php } ?>


					<?php if($_Nesne[$vt['nesne_IDdoviz']]['ad']=='doviz'){  ?>
						<div class="dtyborder dtybaslik2"> Döviz</div>
