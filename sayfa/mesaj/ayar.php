...
$_Th=array(
    ...
    array(
        'tip'=>'text',
        'sutunAdi'=>'personel_IDgonderen',
        'deger'=>'',
        'iliskiliSutunAdlari'=>'',
        'sorguDetay'=>'',
        'thIcerigi'=>'<th>Gönderen</th>',
        'genislik'=>'',
        'filtreGrup'=>'personel_IDgonderen'
    ),
    array(
        'tip'=>'text',
        'sutunAdi'=>'personel_IDalici',
        'deger'=>'',
        'iliskiliSutunAdlari'=>'',
        'sorguDetay'=>'',
        'thIcerigi'=>'<th>Alıcı</th>',
        'genislik'=>'',
        'filtreGrup'=>'personel_IDalici'
    ),
    array(
        'tip'=>'text',
        'sutunAdi'=>'mesaj',
