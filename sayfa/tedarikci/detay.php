...
$vt=z(1,$id,'',$tbl);
$_Nesne=z(37,z(1,"WHERE ad='' OR ad='rehberGrup' OR ad='tedarikciTipi' OR ad='iplikMarka'",'ID,ad,metin1,metin2','nesne'));
?>
<?php if(!empty($vt)&&$vt['arsiv']!='-1'){ ?>
	<div class="dtysayfa">
		<div class="tasiyici">
			<div class="tasiyici1">
					<?php if(!empty($vt['ad'])){  ?>
						<div class="dtyborder dtybaslik2">Tedarikci Adı</div>
						<div class="dtyaciklama"><?php if(!empty($vt['ad'])){ echo $vt['ad']; } ?></div>
					<?php } ?>

                    <?php if(!empty($vt['soyad'])){  ?>
						<div class="dtyborder dtybaslik2">Tedarikci Soyadı</div>
						<div class="dtyaciklama"><?php if(!empty($vt['soyad'])){ echo $vt['soyad']; } ?></div>
					<?php } ?>

                    <?php if(!empty($vt['telCep1'])){  ?>
						<div class="dtyborder dtybaslik2">Tedarikci Telefonu</div>
						<div class="dtyaciklama"><?php if(!empty($vt['telCep1'])){ echo $vt['telCep1']; } ?></div>
					<?php } ?>

                    <?php if(!empty($vt['telCep2'])){  ?>
						<div class="dtyborder dtybaslik2">Tedarikci Telefonu 2</div>
						<div class="dtyaciklama"><?php if(!empty($vt['telCep2'])){ echo $vt['telCep2']; } ?></div>
					<?php } ?>

                    <?php if(!empty($vt['telSabit'])){  ?>
						<div class="dtyborder dtybaslik2">Tedarikci Sabit Telefonu</div>
						<div class="dtyaciklama"><?php if(!empty($vt['telSabit'])){ echo $vt['telSabit']; } ?></div>
					<?php } ?>

                    <?php if(!empty($vt['telFax'])){  ?>
						<div class="dtyborder dtybaslik2">Tedarikci Fax Bilgisi</div>
						<div class="dtyaciklama"><?php if(!empty($vt['telFax'])){ echo $vt['telFax']; } ?></div>
					<?php } ?>

                    <?php if(!empty($vt['unvan'])){  ?>
						<div class="dtyborder dtybaslik2">Tedarikci Ünvanı</div>
                ...
                <?php if(!empty($vt['eposta'])){  ?>
                    ...
                    <?php if(!empty($vt['markalar'])){  ?>
						<div class="dtyborder dtybaslik2">Tedarikci Markaları</div>
