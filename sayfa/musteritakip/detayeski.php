...
<?php if(!empty($vt)&&$vt['arsiv']!='-1'){ ?>
				...
				<table cellpadding="0" cellspacing="0">
					<tbody>
						...
						<?php if(!empty($vt['asama'])){ ?>
							<tr><th>Durum</th><td><?php if($_NesneDurum[$vt['asama']]['metin1']){ echo $_NesneDurum[$vt['asama']]['metin1'];} ?></td></tr>
						<?php } else {  ?>
	...
	<?php 
	$hatirlatici=z(1,array('arsiv'=>0,'hmodul'=>'musteritakip','hmodul_ID'=>$id),'','hatirlatici');
