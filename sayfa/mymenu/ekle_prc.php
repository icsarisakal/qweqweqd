...
.yuklemebaslat{
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-9">
            <textarea name="<?php echo $tbl?>[aciklama]" rows="5" cols="5" class="form-control" tabindex="1"  utofocus="autofocus" required="required" value="<?php echo !empty($_X['aciklama'])?$_X['aciklama']:''?>" autocomplete="off"></textarea>
        </div>
    </div>
