    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                <a href="./?s=<?php echo $sayfayiyakala1s; ?>&a=listele" class="breadcrumb-item"><i class="icon-home2 mr-2"></i>Favori Menü</a>
...
//favori jquery ajax işlemleri
   $('.favsatir').on('click',function(){



        if($(this).next().find('.fav').is(':not(:checked)')){
            //ajax veri tabanı yeni kayıt
           
            var id = $(this).next().find('.fav').attr('id');
            var url = $(this).next().find('.fav').val();
            var ad = $(this).next().find('.fav').attr('name');
            var personel=$('#personelcek').val();
          //  alert(id+'\n'+url+'\n'+'\n'+ad+'\n'+personel+' 1.loop');

            $.ajax({

                type:'post',
                url:'ajaxayar.php?s=mymenu&a=ajaxsorgu&durum=ekle&personel='+personel+'&id='+id,
                success:function(e){

                        console.log(e.cevap.gelen);
                        console.log(e.cevap.mymenuarray);
            ...
            $($('#s_mymenu').next()).append('<li id="'+id+'" class="nav-item navtikla "><a class="nav-link navclick" href="'+url+'"><i class="icon-design"></i>'+ad+'</a></li>');



            $(this).next().find('.fav').prop('checked',true);

        }else if($(this).next().find('.fav').is(':checked')){
            //ajax veri tabanı sil
           ...
           // alert(id+'\n'+url+'\n'+'\n'+ad+'\n'+personel+' 2.loop');
            ...
            $($('#s_mymenu').next()).find('a').each(function() {
            ...
            $(this).next().find('.fav').prop('checked',false);
        }
...
function favtikla(ths){
    //var tiklama=$(ths).find(".fav");
    //$(tiklama).click();
}
</script>
...
<!-- Gizli Personel Bilgisi Gönderme İnputu -->

<input id="personelcek" hidden="true" type="text" value="<?php echo $personelcek['ID'];  ?>">
