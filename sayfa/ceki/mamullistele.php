   ...
   <?Php switch(z(33,'sil')){
    ...
    <table cellpadding="0" cellspacing="0" border="0">
        ...
        <thead>
            ...
            <?php filtreTh('yok','girisAdi') ?>
            <?php filtreTh('yok','cikisAdi') ?>
            <?php filtreTh('text','aciklama') ?>
            <?php filtreTh('text','boyahanePartiNo') ?>
            <?php filtreTh('select','mamulkumasdetay','','ID,ad,kod',"WHERE ad<>'' OR kod<>''") ?>
            <?php filtreTh('select','mamulkumas','','ID,ad,numuneAdi',"WHERE ad<>'' OR numuneAdi<>''") ?>
        ...
        <tbody id="tbody">
			<?Php require('sayfa/'.$tbl.'/mamullistele_prc.php'); ?>
        </tbody>
        <?php listeleTfoot(16,1,array('cokluIslem'=>array(
...
<?php filtreTh('ajaxAraJs',array('dosya'=>'mamullistele_ajx.php')) ?>
