...
if(!empty($_G)){
	...
	foreach($_G as $ad=>$dgr){
		...
		if($ad=='durum'){print_r($dgr);die;}
				...
				else if(in_array($ad,Array('aciklama','numuneIsmi','tarih','dokSalTopNo','notlar'))){
					$araSd.=$ad." LIKE '%".$dgr."%'";
				}
...
if(!empty($_X)){
	...
	$_Mamulkumas=z(37,z(1,"WHERE ".z(38,$_X,'mamulkumas_ID'),'ID,ad,numuneAdi','mamulkumas'));
