...
<?php require(__DIR__.'/../hambezstok/ceki_prc/cikis_frm_pst.php'); ?>
<?php require(__DIR__.'/../hambezstok/ceki_prc/topluekle_pst.php'); ?>
<?php require(__DIR__.'/../hambezstok/ceki_prc/cikis_frm.php'); ?>
<?php require(__DIR__.'/../hambezstok/ceki_prc/cikis_frm_js.php'); ?>
<?php
...
<div class="sayfa">
	...
	'					<tr>
					...
					<tbody class="bunun-icine-yapistir cekibody" id="cekibody">
						<?Php if(!empty($barkodluA)){$geriYukle=1;require('sayfa/hambezstok/ceki_prc/cekitr_prc.php'); } ?>
					</tbody>
		    ...
		    <input type="hidden" name="cikisboyatakip_ID" value="<?php 
				...
				echo !empty($_Cekicikisfrm['cikisboyatakip_ID'])?$_Cekicikisfrm['cikisboyatakip_ID']:'';
		     ?>" />
...
<?php
	if(empty($barkodluA)){
		...
		require(__DIR__.'/../hambezstok/ceki_prc/topluekle_barkodlu_js.php');
	}
?>