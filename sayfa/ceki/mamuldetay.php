...
<div class="sayfa">
    ...
    <div class="printx">
        <div class="baslik">
            <div class="btnGrup">
                <a href="<?php echo $kodx==false?'?ceki='.$KOD:'?s=ceki&a=mamuldetay&id='.$ID;?>&yazdir=1" class="btn btnYazdir">YAZDIR TR</a><!--
             --><a href="<?php echo $kodx==false?'?ceki='.$KOD:'?s=ceki&a=mamuldetay&id='.$ID;?>&yazdir=1&dil=en" class="btn btnYazdir">YAZDIR EN</a><!--
             --><a href="<?php echo $kodx==false?'?ceki='.$KOD:'?s=ceki&a=mamuldetay&id='.$ID;?>&yazdir=2" class="btn btnYazdir">ANTETSİZ YAZDIR</a><!--
             --><a href="<?php echo $kodx==false?'?ceki='.$KOD:'?s=ceki&a=mamuldetay&id='.$ID;?>&yazdir=2&dil=en" class="btn btnYazdir">ANTETSİZ EN</a><?Php 
   ...
   <?Php switch(z(33,'onayla1')){
    ...
    <table cellpadding="0" cellspacing="0" border="0">
        ...
        <tbody id="tbody">
			<?Php require(__DIR__.'/mamuldetay_prc.php'); ?>
        </tbody>
    </table>
