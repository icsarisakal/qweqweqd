...
<div class="sayfa">
   ...
   <?Php switch(z(33,'sil')){
    ...
    <table cellpadding="0" cellspacing="0" border="0">
        <colgroup>
            <col width="28" /><col width="28" /><col width="60" /><col width="80" /><col /><col /><col /><col /><col /><col /><col />
        ...
        <thead>
            ...
            <?php filtreTh('select','personel','','ID,ad,soyad') ?>
        ...
        <tbody id="tbody">
			<?Php require('sayfa/'.$tbl.'/mamullistelepersonel_prc.php'); ?>
        </tbody>
        <?php listeleTfoot(12,1,array('cokluIslem'=>array(
...
<?php filtreTh('ajaxAraJs',array('dosya'=>'mamullistelepersonel_ajx.php')) ?>
