...
require(__DIR__.'/makinacesitleri/ayar.php');
if(z(8,'a')){
	$a=z(8,'a');
	...
	if(z('lgn','admin')||ytk(z(8,'s'), str_replace(array('listele','detay','ekle','duzenle','ajaxsorgu'),array('listele','detay','ekle','duzenle','listele'),$a) )){
